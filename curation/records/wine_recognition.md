...
Found on UCI. It already has some features missing. It is a wine origin prediction from the 90s. Liikely trivial as RF can perfectly solve it according to UCI. 

Given all of this, I would veto to skip it, also due its age
