...
and in some cases Congress overturned adecision before 1988, not all cases
were "available" for action for the entire lO-year period, so the logarithm
...
Correct target seems to be regression number of actions taken. We could overule to clf as well
