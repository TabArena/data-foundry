...
After consulting Dr. GPT, learned that ALT features correspond to future follow-up measurements - temporal leakage. We could use the other features, but that's probably not very useful.
