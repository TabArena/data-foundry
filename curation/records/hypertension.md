...
Is highly realted or even a copy of CDC  Indicators of Heart Disease

Given the large overalp in features and task with other (older than TableShift) tasks for brfss data, we judge this to be a "duplicate" in that it is a different version of the same data
