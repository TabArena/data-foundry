---
unique_name: analcatdata_bankruptcy
name: analcatdata_bankruptcy
suggestion: 'No'
decision_markers:
- Duplicate
tags:
...
- '?'
source_links:
- https://github.com/EpistasisLab/pmlb/blob/master/datasets/analcatdata_bankruptcy/metadata.yaml
