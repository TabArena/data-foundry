...
source_links:
- https://www.openml.org/search?type=data&id=15
...
Nowadays solved differently, domain features extracted from images

Potential issue: Maybe Image domain, outdated

Lennart: Image, Outdated Tabular Problem
