...
Contains one comment column that is empty in 87% of the time. Most of the comments are not super releavnt comapred to the rest of the survey. If we filter to those with good comments, we end up with almost no data. So we can skip this data for now.
