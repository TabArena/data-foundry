---
unique_name: analcatdata_asbestos
...
- '?'
source_links:
- https://github.com/EpistasisLab/pmlb/blob/master/datasets/analcatdata_asbestos/metadata.yaml
...
83 samples,  too small with 3-fold CV.
