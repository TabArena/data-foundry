...
- '?'
source_links:
- https://github.com/EpistasisLab/pmlb/blob/master/datasets/analcatdata_fraud/metadata.yaml
...
42 samples,  too small with 3-fold CV.
