...
We use the prot data and ignore the math data, as it is more or less a different version/target (382 students overlap) and the port data is larger. We only predict G3
