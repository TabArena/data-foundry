---
unique_name: analcatdata_happiness
name: analcatdata_happiness
suggestion: 'No'
decision_markers:
- Duplicate
tags:
...
- '?'
source_links:
- https://github.com/EpistasisLab/pmlb/blob/master/datasets/analcatdata_happiness/metadata.yaml
...
60 samples,  too small with 3-fold CV.
